...
HELP_TEXT = (
    "📡 <b>Tech Slop Bot</b> — новостная лента из Telegram-каналов\n\n"
    "Парсит добавленные каналы, приводит новости к единому формату "
    "(заголовок, детали, тег категории) и присылает сюда.\n\n"
